...
parser.add_argument('--test_dir',default='../test/VIPeR/pytorch',type=str, help='./test_data')
...
if __name__ == '__main__':
    model_structure = models.init_model(name='mobilenet', num_classes=751)
    #
    ...
    scipy.io.savemat('../test/VIPeR/pytorch_result_viper_%s.mat'%opt.which_epoch,result)
